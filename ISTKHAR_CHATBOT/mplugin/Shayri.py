import random
from ISTKHAR_CHATBOT.database import get_served_chats
...
async def shayri(client: Client, message: Message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("❍ 𝐔ᴘᴅᴀᴛᴇ ❍", url="https://t.me/aoclifelifestyl"),
                    InlineKeyboardButton("❍ 𝐒ᴜᴘᴘᴏʀᴛ ❍", url="https://t.me/arame9"),
                ]
           ]
        ),
    )
