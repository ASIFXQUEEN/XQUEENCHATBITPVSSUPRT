...
from ISTKHAR_CHATBOT.idchatbot.helpers import is_owner
from ISTKHAR_CHATBOT import mongo
...
import time
import io
from ISTKHAR_CHATBOT import CLONE_OWNERS, db, ISTKHAR_CHATBOT
...
from ISTKHAR_CHATBOT.database.clonestats import get_served_cchats, get_served_cusers, add_served_cuser, add_served_cchat
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup, Message, CallbackQuery
from ISTKHAR_CHATBOT.idchatbot.helpers import (
    START,
    START_BOT,
    PNG_BTN,
    CLOSE_BTN,
...
async def add_bot_to_chats():
    try:
        ...
        bot = await ISTKHAR_CHATBOT.get_users(users)
        bot_id = bot.id
